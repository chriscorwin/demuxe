/*
 ...
 A trait is a pure function that implements the following pattern:
	 ...
	 isAssetForTrait: Function (assetFileName) - This method accepts the file name
		 ...
		 to this trait.
	 addTraitData: Function (foundData, stepInfo, assetFileName, assetFileIndex) 
		 - This method accepts the currently found traits data, the stepInfo,
		 ...
		 - `foundData` has a `stepDataAttributes` array that you will set properties
 ...
 ```
	const fakeTrait = {
		...
		addTraitData: (foundData, stepInfo, assetFileName, assetFileIndex) => {
			...
			foundData.stepDataAttributes['hasFakeTrait'] = true;
			foundData.stepDataAttributes['fakeTraitPathToAssetFile'] = pathToAssetFile;
